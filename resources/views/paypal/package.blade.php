...
<!--End of Tawk.to Script-->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="mt-0" id="form_order1" method="post" enctype="multipart/form-data"
                        action="{{ url('profile\storecommentservice') }}">
                        @csrf
                ...
                <div class="card position-sticky top-0">
                    <div class="p-3 bg-opacity-10" style="background-color: #060818;">
                        ...
                        <div class="d-flex justify-content-between mb-1 small">
                            <span>القسم</span> <span>باقة</span>
                        </div>
                        <hr>
    ...
    <form class="mt-0" id="form_order" method="post" style="display:none;">
        @csrf
        <input type="hidden" name="package_id" id="package_id" value="{{ $orders->id }}" />
    </form>
