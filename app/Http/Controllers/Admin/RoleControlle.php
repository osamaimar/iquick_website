...
class RoleControlle extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('dashborad/roles/create')->withSuccess(__("admin.added successfully"));
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect("dashborad/roles/$id/edit")->withSuccess(__("admin.updated successfully"));
    }
    /**
